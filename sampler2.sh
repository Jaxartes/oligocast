...
doit $m4base.7 -E - $u4base.1 $u4base.1,$u4base.2 $u4base.3 -
doit $s4base.8 -I - $u4base.4 $u4base.4,$u4base.5 $u4base.6 -
doit $m6base:7 -E - $u6base:1 $u6base:1,$u6base:2 $u6base:3 -
doit $s6base:8 -I - $u6base:4 $u6base:4,$u6base:5 $u6base:6 -
